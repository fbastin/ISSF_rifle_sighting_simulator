...
\author{Documentation for \texttt{simulator.js} / \texttt{sight.html}}
\date{April 2026}
...
Open \file{sight.html} in any modern web browser. The page loads
...
\begin{enumerate}[nosep]
  \item Open \file{sight.html}. The default view shows a 10\,m air-rifle
